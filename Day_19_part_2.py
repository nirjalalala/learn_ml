#----
# copy this code in an IDE with requirements fulfilled.
#run this file with "streamlit run 'filename'" to view the page on localhost.


#make sure to download all files from Colab 'files' and put them in the same folder as this file
#    tuned_regression_rfr.pkl
#    baseline_regression_rfr.pkl
#    scaler.pkl
#    df-scaled.csv

#The files will be available after running all cells in Day_19_part_1.ipynb
#Download them.
